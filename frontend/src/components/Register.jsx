        ...
        <div className='row justify-content-center'> 
            <div className='col-md-6 bg-light-dark p-5 rounded'>
                ...
                <form action="" onSubmit={handleSubmit}>
                    ...
                    <div className='mb-3'>
                        <input type="email" value={email}className='form-control ' onChange={(e)=>setEmail(e.target.value)} placeholder='Enter email address'/>
                    ...
                    {success && <div className='alert alert-success'>Registration Sucessfull</div>}
                    
                    {loading ? ( <button disabled type='submit' className='btn btn-info d-block mx-auto '>Please Wait.....</button>):( <button type='submit' className='btn btn-info d-block mx-auto '>Register</button>) }
